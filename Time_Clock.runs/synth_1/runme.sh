...
HD_PWD='D:/KIMGYUHAN/project/FPGA/Time_Clock/Time_Clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Time_Clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Time_Clock.tcl
