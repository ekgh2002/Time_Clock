...
HD_PWD='D:/KIMGYUHAN/project/FPGA/Time_Clock/Time_Clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Time_Clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Time_Clock.tcl -notrace
